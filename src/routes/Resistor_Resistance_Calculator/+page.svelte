...
<div id="main-div">
	<div class="band-select">
		<div>
			...
			<select
				id="select-band1"
				style="background-color: {value_to_colour[band1]}"
				name="band1"
				class="select"
				bind:value={band1}
			>
		...
		<div>
			...
			<select
				id="select-band2"
				style="background-color: {value_to_colour[band2]}"
				name="band2"
				class="select"
				bind:value={band2}
			>
		...
		<div>
			...
			<select
				id="select-band3"
				style="background-color: {value_to_colour[band3]}"
				name="band3"
				class="select"
				bind:value={band3}
			>
		...
		<div>
			...
			<select
				id="select-band4"
				style="background-color: {band4_value_to_colour[band4]}"
				name="band4"
				class="select"
				bind:value={band4}
			>
